...
ActiveRecord::Schema.define(:version => 20130301203719) do
  ...
  add_index "camera_statuses", ["camera_id"], :name => "index_camera_statuses_on_camera_id"
  ...
  create_table "snapshot_requests", :force => true do |t|
